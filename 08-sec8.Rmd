...
```{r sec8_boxplots_semestre, fig.width=12, fig.height=8}
library(tidyverse)
library(scales)
...
```{r sec8_mapa_muertes, warning=FALSE, message=FALSE, out.width="100%"}
library(dplyr)
library(readr)
library(stringr)
library(janitor)
...
```{r sec8_mapa_tasa, warning=FALSE, message=FALSE, out.width="100%"}
library(dplyr)
library(readr)
library(stringr)
library(janitor)
