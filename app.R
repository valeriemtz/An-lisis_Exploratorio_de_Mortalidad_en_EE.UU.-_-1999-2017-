...
ui <- bs4DashPage(
  ...
  sidebar = bs4DashSidebar(
    ...
    bs4SidebarMenu(
      ...
      bs4SidebarMenuItem("Video YouTube", tabName = "video", icon = icon("youtube")),
  ...
  body = bs4DashBody(
    ...
    bs4TabItems(
      ...
      bs4TabItem(tabName = "video",             tab_videoUI("mod_video"))
    )
  ),
